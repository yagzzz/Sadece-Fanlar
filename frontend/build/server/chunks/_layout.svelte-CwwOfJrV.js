import { c as create_ssr_component, a as subscribe, e as each, v as validate_component, b as createEventDispatcher, d as add_attribute, f as escape } from './ssr-CAqK4lyn.js';
import './auth-DjJDNFfu.js';
import 'clsx';
import { c as cn } from './index2-O1tI1Vis.js';
import { w as writable } from './index-BTslQZ0_.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_toasts();
  return `${$$result.head += `<!-- HEAD_svelte-hzyevq_START -->${$$result.title = `<title>SadeceFanlar - Anonymous Creator Platform</title>`, ""}<meta name="description" content="Support your favorite creators anonymously with cryptocurrency payments. Privacy-first content platform."><!-- HEAD_svelte-hzyevq_END -->`, ""} <div class="min-h-screen bg-neutral-50 dark:bg-neutral-950">${slots.default ? slots.default({}) : ``}</div>  <div class="fixed top-4 right-4 z-50 space-y-2 pointer-events-none">${each($toasts, (toast) => {
...
//# sourceMappingURL=_layout.svelte-CwwOfJrV.js.map
