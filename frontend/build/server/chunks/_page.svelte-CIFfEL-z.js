import { c as create_ssr_component, a as subscribe, v as validate_component, d as add_attribute, f as escape } from './ssr-CAqK4lyn.js';
...
import { C as Card } from './Card-lbOv-Js6.js';
import { I as Input } from './Input-CaumhLVj.js';
import { A as Avatar } from './Avatar-Cfr0OREM.js';
import 'clsx';
import { T as Tabs } from './Tabs-BRoncGjm.js';
import { T as Textarea, S as Switch } from './Switch-D1zCKnx0.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-13d280r_START -->${$$result.title = `<title>Ayarlar | SadeceFanlar</title>`, ""}<!-- HEAD_svelte-13d280r_END -->`, ""} <div class="p-4"><h1 class="text-2xl font-bold text-neutral-900 dark:text-white mb-6" data-svelte-h="svelte-w7nyo">Ayarlar</h1> ${validate_component(Tabs, "Tabs").$$render(
      $$result,
      { tabs, activeTab },
      {
        activeTab: ($$value) => {
...
//# sourceMappingURL=_page.svelte-CIFfEL-z.js.map
