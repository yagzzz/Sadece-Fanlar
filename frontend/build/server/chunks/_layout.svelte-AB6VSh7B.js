import { c as create_ssr_component, a as subscribe, e as each, v as validate_component, b as createEventDispatcher, d as add_attribute, f as escape } from './ssr-CxJiF8w8.js';
...
import { w as writable } from './index-YI0dIwkT.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  {
    if ($authStore.initialized && $authStore.user?.status === "suspended" && $page.url.pathname !== "/suspended") {
      goto();
    }
  }
  $$unsubscribe_page();
...
//# sourceMappingURL=_layout.svelte-AB6VSh7B.js.map
