import { c as create_ssr_component, a as subscribe, f as escape, v as validate_component, e as each } from './ssr-CxJiF8w8.js';
import { a as api } from './client-DAdgJWpw.js';
import { a as authStore } from './auth-1cButIF9.js';
import { P as PostCard } from './PostCard-BRGtlgpr.js';
import 'clsx';
...
import { A as AdSlot } from './AdSlot-fj2CHqgD.js';
import './index-YI0dIwkT.js';
import './index2-Dhq654YE.js';
import 'tailwind-merge';
import './Avatar-CISotdOD.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div>` : `${validate_component(AdSlot, "AdSlot").$$render($$result, { position: "feed" }, {}, {})} ${each(posts, (post, i) => {
    return `${validate_component(PostCard, "PostCard").$$render($$result, { post }, {}, {})} ${i === 4 ? `${validate_component(AdSlot, "AdSlot").$$render($$result, { position: "feed" }, {}, {})}` : ``}`;
...
//# sourceMappingURL=_page.svelte-Dxp8G8cW.js.map
